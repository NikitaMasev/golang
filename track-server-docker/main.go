...
2. Build Docker container: $ sudo docker build -t golang-latest .
3. Run Docker container: $ sudo docker run -e CONSUL_HTTP_ADDR=8500 -p 8085:8085 -p 8500:8500 golang:latest
